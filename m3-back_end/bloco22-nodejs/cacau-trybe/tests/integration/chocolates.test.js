...
describe('Testando a API Cacau Trybe', function () {
  ...
  describe('Usando o método GET em /chocolates/brand/:brandId para buscar brandId1', function () {
  ...
  describe('Usando o método GET na rota /chocolates/total', function () {
    it('Deve retornar o total de chocolates', async function () {
  ...
  describe('Usando GET em /chocolates/search', function () {
    it('Retorna chocolates pela busca em query', async function () {
